...
<div style="margin: auto; position: absolute; top: 50%; left: 50%; bottom: 0; right: 0; transform: translate(-50% -50%); display:inline-block;">
	...
	<form:form class="form-horizontal" method="post" style=""
				...
				<div class="form-group ${status.error ? 'has-error' : ''}">
					<div class="col-sm-10">
						<form:input path="phrase" type="text" class="form-control "
							id="phrase"  placeholder="phrase" style="border : 3px red solid; height: 30 px;" size="50" />
		...
		<div style="float: left;">
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10" style="height:25px; margin: 0px 0px 0px 20px;">
