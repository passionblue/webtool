...
public class NaverOrderHandler extends BaseNaverExcelDataHandler {

    private static Logger m_logger = LoggerFactory.getLogger(NaverOrderHandler.class);

    // Default Constructor
    public NaverOrderHandler(String file) throws Exception {
        super(file);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (File file : files) {
            ...
            if ( file.getName().startsWith("스토어팜_전체주문조회") ||
                    file.getName().startsWith("스토어팜_구매확정내역")  ||
                    file.getName().startsWith("스토어팜_전체주문배송현황") ){
