...
@Entity
@Table(name = "naver_order_history")
public class NaverOrderHistory extends NaverModel{
    ...
    private String dateSendBy;
    private String dateSent2;
    ...
    private String trackNumEntered;  //송장번호
    private String dateTrackNumEntered;
    private Boolean notSent; // enter trackCode without sending
    ...
    private String  orderPlacementNumber; // if one or more orders were combined or different order code was used other than orderNum; 
    ...
    // Default Constructor
    public NaverOrderHistory(String titleType, String titleDate) {
        this.titleDate = titleDate;
        this.titleType = titleType;
    }

    public NaverOrderHistory(){
